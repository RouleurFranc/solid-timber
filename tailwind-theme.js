...
export default {
  ...
  'family:box': {
    decorator:
      'block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-green-accent text-transparent peer-checked:text-green-accent',
    decoratorIcon:
  ...
  'family:dropdown': {
    ...
    inner:
      'max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-green-accent focus-within:ring-2 rounded mb-2 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-green-accent',
    ...
    loaderIcon: 'ml-auto',
    loadMoreInner:
      'flex items-center justify-center text-sm p-2 text-center w-full text-green-accent formkit-loading:text-gray-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0',
    option: 'p-2.5',
  ...
  'family:text': {
    inner:
      'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-green-accent focus-within:ring-2 [&>label:first-child]:focus-within:text-green-accent rounded mb-1',
    input:
  ...
  select: {
    inner:
      'flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-green-accent focus-within:ring-2 [&>span:first-child]:focus-within:text-green-accent',
    input:
  ...
  textarea: {
    inner:
      'flex max-w-md rounded mb-1 ring-1 ring-gray-400 focus-within:ring-green-accent [&>label:first-child]:focus-within:text-green-accent',
    input:
  ...
  datepicker: {
    ...
    month: `
        ...
        bg-gray-200
        aria-selected:bg-green-accent aria-selected:text-white
        focus:outline focus:outline-2 focus:outline-green-accent focus:outline-offset-2 focus:bg-white focus:text-black
    ...
    dayCell: `
      ...
      `,
    timeInput:
      'w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-green-accent',
    ...
    dayButton:
      'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-green-accent',
    monthButton:
      'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-green-accent',
    yearButton:
      'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-green-accent',
    ...
    openButton: `
        ...
        focus-visible:outline-none focus-visible:text-white focus-visible:bg-green-accent
      `,
    calendarIcon:
  ...
  repeater: {
    ...
    downControl:
      'hover:text-green-accent disabled:hover:text-inherit disabled:opacity-25',
    fieldset: 'py-4 px-5',
    help: 'mb-2 mt-1.5',
  ...
  slider: {
    ...
    fill: 'h-full rounded-full absolute top-0 mx-[-4px] bg-green-accent',
    ...
    handle:
      'group w-4 h-4 rounded-full bg-white absolute top-1/2 left-0 z-[2] -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:ring-2 ring-green-accent data-[is-target="true"]:z-[3]',
    tooltip:
      'absolute bottom-full left-1/2 -translate-x-1/2 -translate-y-[4px] bg-green-accent text-white py-1 px-2 text-xs leading-none whitespace-nowrap rounded-sm opacity-0 pointer-events-none transition-opacity after:content-[""] after:absolute after:top-full after:left-1/2 after:-translate-x-1/2 after:-translate-y-[1px] after:border-4 after:border-transparent after:border-t-green-accent group-hover:opacity-100 group-focus-visible:opacity-100 group-data-[show-tooltip="true"]:opacity-100',
  ...
  taglist: {
    ...
    tagWrapper:
      'mr-1 focus:outline-none focus:text-white [&>div]:focus:bg-green-accent [&>div>button]:focus:text-white',
    tagLabel: 'pl-2 pr-1',
  ...
  toggle: {
    ...
    track:
      'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-green-accent peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
    valueLabel: 'font-bold text-sm',
    wrapper: 'flex flex-wrap items-center mb-1',
  },
  transferlist: {
    outer: `
        [&_.dnd-placeholder]:bg-green-accent [&_.dnd-placeholder]:text-white
    ...
    transferlistListItem:
      'pl-8 relative aria-selected:bg-green-light aria-selected:data-[is-active=true]:bg-green-light aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-green-accent data-[is-active=true]:bg-gray-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center',
